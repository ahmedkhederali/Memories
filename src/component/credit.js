        ...
        <div >
            <form>
                <div className="d-flex justify-content-between mt-4">
                    <div class="form-floating mb-3 col-5">
                        ...
                        <label for="floatingInput" className="vis_label">Number</label>
                    </div>
                    <div class="form-floating mb-3 col-5">
                        <input type="text" className="form-control"
                            name='name'
                            ...
                            onFocus={e => setfocus(e.target.name)} />
                        <label for="floatingInput" className="vis_label">Name</label>
                    </div>
                </div>
                <div className="d-flex justify-content-between">
                    <div class="form-floating mb-3 col-5">
                        <input type="date" className="form-control" style={{}}
                            ...
                            onFocus={e => setfocus(e.target.name)}
                        />
                        <label for="floatingInput" className="vis_label">Expirey</label>
                    </div>
                    <div class="form-floating mb-3 col-5">
            ...
            <section className="d-flex align-items-center justify-content-between">
                <div class="form-check">
                    ...
                    />
                    <Link to={'trems/true'} className="form-check-label checklabels p-0 m-0" for="flexCheckDefault" style={{ fontSize: 12, textDecoration: 'underline' }} >
