...
const PhotoEditor = ({ image, onImageEdited, url, name,inputRef}) => {
  ...
  return (
    <div className='d-flex justify-content-center' style={{height:"100%"}}>
      ...
      <div className='btn-div h-100  '>
        <button  onClick={handleRotateLeft} className='rotate-btn p-2 mb-2 ms-2'>Left</button>
        <button onClick={handleRotateRight} className='rotate-btn  p-2 mb-2 ms-2 '>Right</button>
        <button onClick={() => handleSave(name,title)} className='save-btn  p-2 ms-2'>Save Image</button>
