...
//     return(
//      <>
//   <footer className="nb-footer arc">
//     <div className="container mb-4">
//       <div className="row">

//         <div className="col-md-4 col-sm-4 pt-5">
//           <div className="footer-info-single">
//             <h2 className="title mb-2">مدعوم من</h2>
...
//         <div className="col-md-4 col-sm-4 pt-5">
//           <div className="footer-info-single">
//             <h2 className="title mb-2">الرعاة</h2>
...
//         <div className="col-md-4 col-sm-4 pt-5">
//           <div className="footer-info-single">
//             <h2 className="title mb-2">تواصل معنا</h2>
//             <div className='col-12'>
//              <ul className='row'>
...
//           <a href='#' className='terms'>الشروط والأحكام</a>
//           </div>
        ...
        <div className="mx-3 ">
          <div className="row">
            ...
            <div className="col-md-6 col-sm-6 ">
              <div className="footer-info-single">
                <h2 className="title mb-2 text-center">الرعاة</h2>
            ...
            <div className="col-md-4 col-sm-3 ">
              <div className="footer-info-single">
                <h2 className="title mb-2 text-center"  style={{borderLeft: '0px solid #F29222 '}}>تواصل معنا</h2>
                <div className='col-12'>
                  <ul className='row ps-1 p-0'>
                  <a className='col-lg-3 col-md-3 col-sm-4 col-2 mb-1'  href={link1.url}><img src={xlogo} className='w-50' style={{ borderRadius: "50%", border: '2px solid white' }} /></a>
                    ...
                    <a className='col-lg-3 col-md-3 col-sm-4 col-2 mb-1'  href={link6.url}><img src={twich} className='w-50' style={{ borderRadius: "50%" }} /></a>
                  </ul>
        ...
        <section className="copyright">
          <div className="container">
            <div className="row">
              ...
              <Link to={'trems/false'} className='terms'>الشروط والأحكام</Link>
              </div>
              <div className="col-sm-6" />
            </div>
          </div>
