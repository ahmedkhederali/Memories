...
import imagegif from "../assest/giphy.gif";
import imggif2 from "../assest/giphy (1).gif";
...
function Uploading({ data, setImageID, addedImagee, setAddedImages, price, offer, offer_number, length, holdspot }) {
  ...
  const popoverInstagram = (
    <Popover id="popover-instagram">
      ...
      <Popover.Body><input type="text" value={instgram} onChange={(e) => setinstgram(e.target.value)} className="rounded" /></Popover.Body>
    </Popover>
  );
  ...
  const popoverTwitter = (
    <Popover id="popover-twitter">
      ...
      <Popover.Body><input type="text" value={twitter} onChange={(e) => settwitter(e.target.value)} className="rounded" /></Popover.Body>
    </Popover>
  );

  const popovertiktok = (
    <Popover id="popover-tiktok">
      <Popover.Header as="h3">tiktok</Popover.Header>
      <Popover.Body><input type="text" value={Facebook} onChange={(e) => setfacebook(e.target.value)} className="rounded" /></Popover.Body>
    </Popover>
  );
  ...
  const handlenext_1 = async () => {
    ...
    if (selectedImages.length > 0 && email) {
      ...
      Swal.fire({
        title: 'Check Again',
        text: 'You must add an image, author, and title.',
        icon: 'warning',
        confirmButtonText: 'OK',
      });
  ...
  const handelenext_3 = async (event) => {
    ...
    if (length + dataimage.length < 1000000 - holdspot) {
      try {
        ...
        if (axiosResponse.status === 201) {
          ...
          if (pornimage == 0) {
            ...
            Swal.fire({
              title: "Uploading",
              text: `${dataimage.length - pornimage} uploading. but ${pornimage} didn't upload because it +18 images`,
              icon: "success",
              confirmButtonText: "OK",
              preConfirm: async () => {
                // Your logic before calling the API
          ...
          Swal.fire({
            title: 'Check Again',
            text: 'check your credit information',
            icon: 'warning',
            confirmButtonText: 'OK',
          });
        }
      ...
      Swal.fire({
        title: "Doesn't Uploading",
        text: "You can't upload the remaining cells for admin",
        icon: "error",
        confirmButtonText: "OK",
        preConfirm: () => {
  ...
  return (
    <div className="upload-page ">
      <a
        type="button"
        className="btn btn-primary upload-btn up_btn d-flex align-items-center justify-content-center"
        ...
        {moving == 1 && (
          <div className="ali">
            ...
            <div>
              <div className="d-flex justify-content-between ">
                <div className="form-floating">
                  ...
                  />
                  <label for="floatingPassword">number :
                    price = {numimage >= offer_number ? numimage * price - (numimage * (price * (extractNumbersAfterPercent(offer) / 100))) : numimage * price}
                  </label>
                </div>
            ...
            <div className="d-flex justify-content-center">
              <button
                type="button"
                className="btn btn-primary d-block mt-2 next-btn"
        ...
        {moving == 3 && (
          <div className="p-3">
            <FontAwesomeIcon
              ...
              style={{ color: "#f29122f1", fontSize: "24px" }}
            />
            <Credit cardData={cardData} setCardData={setCardData} isChecked={isChecked} onCheckboxChange={handleCheckboxChange} />
